    ...
    env_file.write_text(
        "\n".join(
            [
                ...
                "LLM_BINDING_API_KEY=example-local-test-key",
            ]
        )
        + "\n",
        encoding="utf-8",
...
"""
    ...
    assert values["LLM_BINDING_API_KEY"] == "example-local-test-key"
    ...
    env_file.write_text(
        "\n".join(
            [
                ...
                "LLM_BINDING_API_KEY=example-existing-key",
                "EMBEDDING_BINDING_API_KEY=example-existing-key",
            ]
        )
        + "\n",
        encoding="utf-8",
...
"""
    ...
    assert values["LLM_BINDING_API_KEY"] == "example-existing-key"
    assert values["EMBEDDING_BINDING_API_KEY"] == "example-existing-key"
...
"""
    ...
    assert "LLM_BINDING_API_KEY=example-existing-key" in generated_lines
    assert "EMBEDDING_BINDING_API_KEY=example-existing-key" in generated_lines
...
"""
    ...
    assert "LLM_BINDING_API_KEY=example-quick-test-key" in generated_env
    assert "EMBEDDING_BINDING_API_KEY=example-quick-test-key" in generated_env
